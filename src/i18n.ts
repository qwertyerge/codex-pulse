...
export const messages = {
  en: {
    ...
    quota: { label: "Weekly quota", usedRemaining: "Used {used}% · Remaining {remaining}%", resets: "Resets in {countdown}", stale: "No active sessions; updates resume automatically when a task starts", unavailable: "Weekly quota · unavailable", aria: "Codex weekly quota", progressAria: "Codex weekly quota used" },
    session: { open: "Open Codex task: {title}", currentRun: "Current run", sessionAge: "Session age", lastPrompt: "Last prompt", recent: "Recent", ago: "ago", expandRecent: "Expand recent event", collapseRecent: "Collapse recent event", paused: "Recent age paused", pausedTitle: "Recent age paused while expanded" },
  ...
  "zh-CN": {
    ...
    quota: { label: "周额度", usedRemaining: "已用 {used}% · 剩余 {remaining}%", resets: "{countdown} 后重置", stale: "暂无活跃会话；新任务开始后将自动恢复更新", unavailable: "周额度 · 暂不可用", aria: "Codex 周额度", progressAria: "Codex 周额度已用" },
    session: { open: "打开 Codex 任务：{title}", currentRun: "当前运行", sessionAge: "会话时长", lastPrompt: "最近提示", recent: "最近事件", ago: "前", expandRecent: "展开最近事件", collapseRecent: "折叠最近事件", paused: "最近事件计时已暂停", pausedTitle: "展开时最近事件计时已暂停" },
  ...
  fr: {
    ...
    quota: { label: "Quota hebdomadaire", usedRemaining: "Utilisé {used}% · Restant {remaining}%", resets: "Réinitialisation dans {countdown}", stale: "Aucune session active ; les mises à jour reprendront au démarrage d’une tâche", unavailable: "Quota hebdomadaire · indisponible", aria: "Quota hebdomadaire Codex", progressAria: "Quota hebdomadaire Codex utilisé" },
    session: { open: "Ouvrir la tâche Codex : {title}", currentRun: "Exécution en cours", sessionAge: "Âge de la session", lastPrompt: "Dernier prompt", recent: "Récent", ago: "plus tôt", expandRecent: "Développer l’événement récent", collapseRecent: "Réduire l’événement récent", paused: "Âge récent en pause", pausedTitle: "Âge récent en pause pendant le développement" },
